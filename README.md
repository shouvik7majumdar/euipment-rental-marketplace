...
* `return_equipment(listing_id: u32, refund_deposit: bool)`: Owner triggers return. Escrow releases daily rent to owner, and either refunds deposit to renter or releases deposit to owner (claim scenario).
